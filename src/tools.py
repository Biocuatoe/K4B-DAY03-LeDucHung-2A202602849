...
TOOLS_SCHEMA = [
    ...
    # --------------------------------------------------------------------------
    {
        ...
        "description": "Đặt lịch hẹn tư vấn học vụ giữa sinh viên VinUni và Cố vấn học tập theo khung giờ cụ thể.",
        "parameters": {
            "type": "object",
            "properties": {
                "student_id": {
                ...
                "advisor_name": {
                    "type": "string",
                    "description": "Họ tên Cố vấn học tập sẽ tham dự buổi tư vấn (ví dụ: 'PGS.TS Nguyễn Văn A')."
                }
            },
